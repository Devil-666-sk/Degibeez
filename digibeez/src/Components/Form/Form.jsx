...
import { TextField, Button, Typography, Container, Select, MenuItem, FormControl, InputLabel,  Box,} from '@mui/material';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth margin="normal" required>
              ...
              >
                ...
                <MenuItem value="display Advertise">Display Advertising</MenuItem>
            ...
            <TextField
              ...
              required
            />
            <Button type="submit" variant="contained" color="primary" sx={{ width: '100%', background: 'linear-gradient(to right, #121212, #F1F90B)' }}>
              Send Message
            </Button>
          </form>
        </Grid>
